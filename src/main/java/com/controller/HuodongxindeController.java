...
public class HuodongxindeController {
    ...
    public R page(@RequestParam Map<String, Object> params,HuodongxindeEntity huodongxinde,
		...
		if(tableName.equals("putongguanliyuan")) {
			huodongxinde.setGuanliyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("zhiyuanzhe")) {
			huodongxinde.setZhiyuanzhezhanghao((String)request.getSession().getAttribute("username"));
		}
