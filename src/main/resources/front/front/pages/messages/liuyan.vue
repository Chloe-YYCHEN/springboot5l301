	...
	<view class="content my-publish-pv">
		<form>
			<view class="cu-form-group">
				...
				<input :style='{"boxShadow":"none","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(255, 114, 20, 1)","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}' disabled="true" v-model="ruleForm.username" placeholder="留言人用户名"></input>
			</view>
			<view class="cu-form-group">
				<!-- <view :style="userInfoForm.list.title" class="title">留言内容</view> -->
				<textarea :style='{"boxShadow":"none","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(255, 114, 20, 1)","borderRadius":"16rpx","color":"#333","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"300rpx"}' v-model="ruleForm.content" placeholder="留言内容"></textarea>
			</view>
			...
			<view class="cu-form-group" style="text-align:center">
				<button :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","backgroundColor":"rgba(255, 114, 20, 1)","borderColor":"rgba(255, 114, 20, 1)","borderRadius":"8rpx","color":"#fff","borderWidth":"1","width":"100%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</template>
	...
	export default {
		...
		async onLoad(options) {
			...
			this.ruleForm.userid = uni.getStorageSync("userid")
            						                                    if(table == `zhiyuanzhe`){
                this.ruleForm.username = this.user.zhiyuanzhezhanghao
            }
                                                                                                                                                                                                                                                                                                						            						                                    if(table == `putongguanliyuan`){
                this.ruleForm.username = this.user.guanliyuanzhanghao
            }
                                                                                                                        						            			            			            			            			            			            			            			            			            			            			            			            			            			            			            			            			this.styleChange()
		},
		methods: {
