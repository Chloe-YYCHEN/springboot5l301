	...
	<view class="content">
		<form class="app-update-pv">
			...
			<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"308rpx"}' class="cu-form-group">
				<view :style='{"width":"220rpx","fontSize":"40rpx","color":"rgba(255, 114, 20, 1)","textAlign":"left"}' class="title">评论内容</view>
				<textarea :style='{"boxShadow":"none","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(255, 114, 20, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"280rpx"}' v-model="ruleForm.content" placeholder="评论内容"></textarea>
			</view>
...
//跨表计算判断
                ...
                //跨表计算
						if(this.ruleForm.id){
							...
							await this.$api.add(`discusszhiyuanhuodong`, this.ruleForm);
						}
