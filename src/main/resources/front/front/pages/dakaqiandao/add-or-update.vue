	...
	<view class="content">
		<form class="app-update-pv">
			...
			<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				...
				<input :style='{"boxShadow":"none","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(255, 114, 20, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}' :disabled="ro.fuwuleixing" v-model="ruleForm.fuwuleixing" placeholder="服务类型"></input>
			</view>
			...
			<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"220rpx","fontSize":"40rpx","color":"rgba(255, 114, 20, 1)","textAlign":"left"}' class="title">签到时间</view>
				<input :style='{"boxShadow":"none","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(255, 114, 20, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.qiandaoshijian" placeholder="签到时间" @tap="toggleTab('qiandaoshijian')"></input>
			</view>
			<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`dakaqiandao`, this.ruleForm.id);
...
//跨表计算判断
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`dakaqiandao`, this.ruleForm);
						}else{
							await this.$api.add(`dakaqiandao`, this.ruleForm);
						}
