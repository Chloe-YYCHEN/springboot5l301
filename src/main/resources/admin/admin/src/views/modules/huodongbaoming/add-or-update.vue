    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报名原因" prop="baomingyuanyin">
          <el-input v-model="ruleForm.baomingyuanyin" 
              placeholder="报名原因" clearable  :readonly="ro.baomingyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报名原因" prop="baomingyuanyin">
              <el-input v-model="ruleForm.baomingyuanyin" 
                placeholder="报名原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="技能得分" prop="jinengdefen">
          <el-input v-model="ruleForm.jinengdefen" 
              placeholder="技能得分" clearable  :readonly="ro.jinengdefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="技能得分" prop="jinengdefen">
              <el-input v-model="ruleForm.jinengdefen" 
                placeholder="技能得分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baomingyuanyin = true;
          ...
          if(o=='jinengdefen'){
            this.ruleForm.jinengdefen = obj[o];
	    this.ro.jinengdefen = true;
            continue;
          }
          if(o=='baomingshijian'){
