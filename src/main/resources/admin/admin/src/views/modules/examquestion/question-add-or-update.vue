<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择技能测试" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择技能测试">
          <el-option
      ...
      <el-form-item label="测试试题" prop="questionname">
        <el-input
          style="width:600px;"
          type="textarea"
          min="1"
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择技能测试", trigger: "blur" }],
        questionname: [
