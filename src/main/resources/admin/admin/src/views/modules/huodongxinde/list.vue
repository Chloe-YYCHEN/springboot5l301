        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="心得标题">
		     <template slot-scope="scope">
                       {{scope.row.xindebiaoti}}
                     </template>
                </el-table-column>
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="xianchangtupian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="现场图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.xianchangtupian">
                        <img :src="$base.url+scope.row.xianchangtupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
...
export default {
  ...
  methods: {
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          xindebiaoti: row.xindebiaoti,
          xianchangtupian: row.xianchangtupian,
          xindetihui: row.xindetihui,
